...
Выступаю старшим разработчиком: переработал всю архитектуру проекта, провёл полный рефакторинг, включая БД и фронтенд. Мигрировал проект на полноценную СУБД ([postgres](https://un1ver5e.tech/techs/postgres)), сделал интерактивный реактивный веб-интерфейс.

[https://autotunepro.ru](https://autotunepro.ru)

### Nightscout.Online (10.2024 - ...)

Спроектировал проект с нуля, включая фронтенд, бекенд, работу с БД и деплой. Отвечаю за поддержку проекта и реализацию новых фич, выступаю в роли SRE.

[https://nightscout.online](https://nightscout.online)

### Seadox (05.2025 - ...)

Реализовал собственную идею редактора структурированных документов в реальном времени. Использовал современные технологии и надёжный стек, обеспечивающий стабильную работу сервиса.
...
[https://iit.csu.ru](https://iit.csu.ru)
...
### AutotunePro LLC — Lead Developer + Mentor (05.2023 - ...)
